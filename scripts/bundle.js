...
*/
/* eslint-disable */
System.register("base64", [], function (exports_2, context_2) {
    "use strict";
    var Base64;
    ...
    return {
        ...
        execute: function () {
            ...
            exports_2("default", Base64);
        }
    };
});
System.register("Lawnchair", [], function (exports_3, context_3) {
    "use strict";
    var Lawnchair;
    ...
    return {
        ...
        execute: function () {
            ...
            Lawnchair.adapter('dom', (function () {
                ...
                var indexer = function (name) {
                    return {
                        ...
                        all: function () {
                            ...
                            if (a === null)
                                storage.setItem(JSON.stringify(this.key), JSON.stringify([])); // lazy init
                ...
                return {
                    ...
                    get: function (key, callback) {
                        if (this.isArray(key)) {
                            ...
                            for (var i = 0, l = key.length; i < l; i++) {
                                ...
                                var obj = storage.getItem(k), jsonObj;
                                if (obj) {
                            ...
                            if (callback)
                                this.lambda(callback).call(this, jsonObj || obj);
                        }
                        return this;
                    },
                    ...
                    all: function (callback) {
                        var idx = this.indexer.all(), r = [], o, k;
                        ...
                        if (callback)
                            this.fn(this.name, callback).call(this, r);
                        return this;
                    },
            ...
            exports_3("default", Lawnchair);
        }
    };
});
System.register("storage", ["base64", "Lawnchair"], function (exports_4, context_4) {
    "use strict";
    var base64_1, Lawnchair_1, LOCAL, Version, PreviousVersion, LocalStorageObj, Sto;
    ...
    return {
        setters: [
            ...
            function (Lawnchair_1_1) {
                Lawnchair_1 = Lawnchair_1_1;
            }
        ],
        execute: function () {
            /* global */
            "use strict";
            LOCAL = {}, Version = 1.1, PreviousVersion = 1;
            LocalStorageObj = /** @class */ (function () {
            ...
            Sto = new LocalStorageObj();
            exports_4("default", Sto);
        }
    };
});
System.register("lists", [], function (exports_5, context_5) {
    "use strict";
    var LISTSJSON, Spelling;
    var __moduleName = context_5 && context_5.id;
    return {
        setters: [],
        execute: function () {
            exports_5("LISTSJSON", LISTSJSON = {
                "Counties": {
            ...
            exports_5("default", Spelling);
        }
    };
});
System.register("nyckelDB", ["base64", "storage", "lists"], function (exports_6, context_6) {
    "use strict";
    var base64_2, storage_1, lists_1, APP, Windows, cordova, NyckelDB;
