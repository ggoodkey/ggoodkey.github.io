"use strict";
var COM = {
    // relies on Base64 library, uncomment if needed
    // /* globale Base64 */
    ...
    // 	return array;
    // },
    /* generate mailto: link eg. email('bob123','gmail.com','Hi Bob'); */
    email: function (username, domain, subject, message) {
    ...
    * fileExtension could be ".txt", ".png", ".csv", etc. (defaults to .csv)*/
    // readFile: function (formInputId, divOutputId, fileExtension, readAs) {
    ...
    *Works where jQuery $(".class").css("prop") fails*/
    ...
    toSortableNumbers: function (arr) {
        var hig = parseInt(arr[0]), /*highest number in array*/ len = arr.length, out = [];
    ...
    csv2json: function (strData, strDelimiter) {
        function clean(s) {
    ...
    json2csv: function (jsondata, headersArray, separator, textdelim) {
