    ...
    var NyckelDB = (function () {
        ...
        */
        function IMPORT_JSON(json, callback, key, fromLocalStorageBool) {
            ...
            function applyJSON(json) {
                ...
                function directLoadDB() {
                    ...
                    DB[this.id] = {
                        ...
                        "version": this.version + "_" + base64_1.default.Version,
            ...
            if ("data" in json && json.version === this.version + "_" + base64_1.default.Version && base64_1.default.hmac(json.data, key) === json.signature) {
                json = base64_1.default.read(json.data, key);
            }
            if ("title" in json)
        ...
        function BUILD_SEARCH_INDEX(colNamesToIndex, callback) {
            ...
            storage_1.Sto.getItem("searchIndex_" + DB[this.id].title, null, function (obj) {
                if (typeof obj === "string")
                    obj = JSON.parse(obj);
                if (!(obj &&
                    obj.version === this.version + "_" + base64_1.default.Version &&
        ...
        function CREATE_BASE64_FILE(key, token, callback) {
            function dataString() {
                var str = base64_1.default.write(JSON.stringify(EXPORT_DB.call(this)), key);
                return JSON.stringify({
                    "data": str,
                    "signature": base64_1.default.hmac(str, key),
                    "version": this.version + "_" + base64_1.default.Version
                });
            }
            function syncFile() {
            ...
            function syncToken(token) {
                if (token) {
                    ...
                    if (typeof token !== "string" && token && token.version === this.version + "_" + base64_1.default.Version) {
                        if (token.signature && token.token && token.signature === base64_1.default.hmac(token.token, key)) {
                            var dbxSyncObj = JSON.parse(base64_1.default.read(token.token, key));
                ...
                if (!DBX_SYNC_OBJ[title] || DB[this.id].lastModified > DBX_SYNC_OBJ[title])
                    DBX_SYNC_OBJ[title] = DB[this.id].lastModified;
                token = base64_1.default.write(JSON.stringify(DBX_SYNC_OBJ), key);
                return JSON.stringify({
                    "token": token,
                    "signature": base64_1.default.hmac(token, key),
                    "version": this.version + "_" + base64_1.default.Version
                });
            }
        ...
        var NyckelDBObj = /** @class */ (function () {
            function NyckelDBObj(tableTitle) {
                ...
                this.id = base64_1.default.number_hash(tableTitle + base64_1.default.rand(), 12);
            ...
            */
            ...
            NyckelDBObj.prototype.init = function (tableHeaders, columnProperties, options, callback) {
                ...
                function decompress(data, key) {
                    return JSON.parse(base64_1.default.read(data, key));
                }
                ...
                function gotCachedTable(json) {
                    ...
                    if ("data" in json) {
                        if (String(version[1]) === String(base64_1.default.Version) && base64_1.default.hmac(json.data, opt.key) === json.signature) {
                            json = base64_1.default.read(json.data, opt.key);
                ...
                if (opt.importData && opt.importData.data) {
                    if (opt.importData.version !== this.version + "_" + base64_1.default.Version && opt.importData.version !== this.version + "." + base64_1.default.Version) {
                    ...
                    else if (base64_1.default.hmac(opt.importData.data, opt.key) === opt.importData.signature) {
            ...
            */
            ...
            NyckelDBObj.prototype.shuffle = function () {
                function shuffle(array) {
                    var len = array.length, halfLen = Math.ceil(len / 2), random = base64_1.default.rand(halfLen).split(""), r = 0;
                    //shuffle cards
                    if (len > 0) {
                        var array1, array2;
            ...
            NyckelDBObj.prototype.sync = function (json, options, callback) {
                ...
                function sync() {
                    function read(data, key, change) {
                        ...
                        return base64_1.default.read(data, key);
                    }
                    switch (json.signature) {
                        case base64_1.default.hmac(json.data, readKey):
                            json = read.call(this, json.data, readKey, false);
                            break;
                        case base64_1.default.hmac(json.data, opt.initialKey):
                            json = read.call(this, json.data, opt.initialKey || null, true);
                            break;
                        case base64_1.default.hmac(json.data, null):
                ...
                if (wait > 0 && !forceSync)
                    ...
                    json = JSON.parse(json);
                if (!json.data || !(json.version === this.version + "_" + base64_1.default.Version)) {
...
//# sourceMappingURL=nyckelDB.js.map