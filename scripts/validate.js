define(["require", "exports"], function (require, exports) {
    ...
    function validate(words, replacer) {
        if (!words)
            return "";
    ...
    function toEnglishAlphabet(str) {
        if (!str)
            return "";
        var w = str.toString();
        if (/[\xC0-\xDF]/.test(w)) {
    ...
    exports.toEnglishAlphabet = toEnglishAlphabet;
    //TODO: needs work
    function toHTMLSafeAlphabet(str) {
    ...
    exports.toHTMLSafeAlphabet = toHTMLSafeAlphabet;
